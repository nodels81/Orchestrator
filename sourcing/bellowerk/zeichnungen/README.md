...
| `LE-01-knoten-1zu1.svg/.png` | Führleine (Blatt 2/3): **1:1-Prüfblatt** zum Auflegen der fertigen Leine, A4 quer, Kontrollbalken 100 mm | v3.0 |
| `LE-01-knoten-schritte.svg/.png` | Führleine (Blatt 3/3): **Bleed Knot Schritt für Schritt**, farbig, A3 quer. Erzeugt von `mkknoten.py` | v3.0 |
