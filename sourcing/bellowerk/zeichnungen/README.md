...
| `LE-01-detail-flechtung.svg/.png` | Führleine (Blatt 2/3): Flechtanbindung **Maßstab 1:1**, A4 quer, mit Kontrollbalken 100 mm | v2.0 |
| `LE-01-flechtung-schritte.svg/.png` | Führleine (Blatt 3/3): **farbige Schritt-für-Schritt-Anleitung** der Flechtung, A3 quer. Erzeugt von `mkbraid.py` | v2.0 |
