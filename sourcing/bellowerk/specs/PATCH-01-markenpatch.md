...
cap height 6 mm (PA-M) / 5 mm (PA-S), tracking +20 %, max. 10 characters (longer names → patch
PA-L 110 × 18 mm). Björn's decision: **first order = Bellowerk patch only, no names.** Ask the factory
