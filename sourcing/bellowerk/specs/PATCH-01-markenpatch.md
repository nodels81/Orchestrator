# PATCH-01 — Leather Brand Patch "BELLOWERK / Manufaktur" (Tech Pack v1.2, 18 Sep 2026)

**v1.2:** PA-L 110 × 18 mm is now a regular size, not just the fallback for long dog names. The golden
sample of the lead carries the 110 mm patch, and that is the look we keep — **LE-01 uses PA-L, not PA-S.**
...
cap height 6.5 mm (PA-L) / 6 mm (PA-M) / 5 mm (PA-S), tracking +20 %, max. 10 characters on PA-M/PA-S,
16 on PA-L — same blanks as Variant A. Björn's decision: **first order = Bellowerk patch only, no names.** Ask the factory
...
Samples: 5 pcs each size, engraved, with screws. Then **500 pcs PA-L (leads) + 500 pcs PA-M + 250 pcs PA-S**
with screws.
