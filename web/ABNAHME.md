...
| # | Punkt | Urteil |
|---|---|---|
| 6 | Alle Budgets eingehalten, Messwerte beiliegend | **teilweise.** CSS 5,6 KB gzip (Grenze 60) ✓. JavaScript höchstens 1,9 KB pro Seite, keine Bibliothek (Grenze 180) ✓. Schriften: **zwei Familien, 81,2 KB von 120** — Archivo und Bodoni Moda, mitgeliefert statt von Google geladen. IBM Plex Mono wurde am 13.09. gestrichen, weil das Budget zwei Familien erlaubt; die Ziffern richten sich über `tnum` in Archivo aus. LCP, INP, CLS, TTFB und Lighthouse sind von hier aus nicht messbar (kein Server, keine Netzdrosselung). |
