...
description: Review UI/web code (HTML, CSS, React, etc.) against Vercel's Web Interface Guidelines — accessibility, focus states, forms, animation, typography, performance, i18n, dark mode. Use when asked to "review my UI", "check accessibility", "audit design", "review UX", or "check my site against best practices", or before shipping any hand-written web frontend code.
source: https://github.com/vercel-labs/web-interface-guidelines
---

# Web Interface Guidelines (Vercel)

Review the given files for compliance with the rules below. Read files, check against
rules, output concise but comprehensive findings — sacrifice grammar for brevity, high
signal-to-noise.

These are Vercel's own brand/product preferences, not universal law — apply judgment
where a rule conflicts with an explicit project convention.
